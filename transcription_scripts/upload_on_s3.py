...
def upload_transcript_subtitle_to_s3(class_id):
    ...
    try:
        ...
        improved_local_transcript_file_path = f"{BASE_TRANSCRIPT_PATH}{class_id}/{improved_transcript_file_name}"
        ...
        s3_client.upload_file(improved_local_transcript_file_path, S3_BUCKET, f"ai_live_query_resolution/gemini_improved_transcripts/{improved_transcript_file_name}")
